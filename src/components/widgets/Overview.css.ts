/**
 * Overview dashboard styles — vanilla-extract.
 * Token-driven: all colours from contract, works in all 4 themes (D14/D17).
 * The 12-col grid + widget card shapes + per-widget layouts.
 */
...
/** Small live-status dot used inline in statusChip and availHead */
